...
const toDo9 = data.filter(task => task.userId === 9);
console.log("user 9 to-do", toDo9);

const userNineTasks = toDo9.filter(task => task.completed === false);
console.log("user 9 incomplete tasks ", userNineTasks);
