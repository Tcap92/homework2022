...
const post5 = data.filter(task => task.userId === 5);
console.log("user 5s posts", post5);

const userFiveTB = post5.filter(task => task.title && task.body);
console.log("user 5 title/body", userFiveTB);
